            ...
            '3 blueprints public/unlisted/private - created but not published - (visitor profile)' => [
                'sqlQueries' => [
                    ...
                    INSERT INTO blueprints (`id_author`, `slug`, `file_id`, `title`, `current_version`, `created_at`, `exposure`, `type`, `ue_version`) VALUES
                                           (159, 'slug_500', 'file_500', 'title_500', 1, utc_timestamp(), 'public', 'blueprint', '4.12'),
                ...
                'slug'        => '/search/?form-search-input-query=tle&form-search-select-ue_version=4.21&page=1',
                'location'    => null,
                'userID'      => null,
                'contentHead' => [
            ...
            '3 blueprints public/unlisted/private - deleted - (visitor profile)' => [
                'sqlQueries' => [
                    ...
                    INSERT INTO blueprints (`id_author`, `slug`, `file_id`, `title`, `current_version`, `created_at`, `published_at`, `exposure`, `deleted_at`, `type`, `ue_version`) VALUES
                                           (159, 'slug_500', 'file_500', 'title_500', 1, utc_timestamp(), utc_timestamp(), 'public', utc_timestamp(), 'blueprint', '4.12'),
            ...
            '3 blueprints public/unlisted/private - (visitor profile)' => [
                'sqlQueries' => [
                    ...
                    INSERT INTO blueprints (`id_author`, `slug`, `file_id`, `title`, `current_version`, `created_at`, `published_at`, `exposure`, `type`, `ue_version`) VALUES
                                           (159, 'slug_500', 'file_500', 'title_500', 1, utc_timestamp(), utc_timestamp(), 'public', 'blueprint', '4.12'),
    ...
    public static function dataCases30PublicUnlistedPrivateBlueprintPage1(): array
    {
        ...
        return [
            '30 blueprints public/unlisted/private - (visitor profile) - page 1' => [
                'sqlQueries' => [
                    <<<'SQL'
                    INSERT INTO blueprints (`id_author`, `slug`, `file_id`, `title`, `current_version`, `created_at`, `published_at`, `exposure`, `ue_version`)
                        VALUES (179, 'slug_1', 'file_1', 'title_1', 1, utc_timestamp() - interval 2 day, utc_timestamp() - interval 2 day, 'public', '4.0'),
                               (159, 'slug_500', 'file_500', 'title_500', 1, utc_timestamp(), utc_timestamp(), 'public', '4.12'),
                               (159, 'slug_501', 'file_501', 'sync function', 1, utc_timestamp(), utc_timestamp(), 'public', '4.0'),
                               (159, 'slug_2', 'file_2', 'title_2', 1, utc_timestamp() - interval 10 day, utc_timestamp() - interval 10 day, 'public', '4.0'),
                               (169, 'slug_3', 'file_3', 'title_3', 1, utc_timestamp() - interval 3 day, utc_timestamp() - interval 3 day, 'public', '4.0'),
                               (179, 'slug_4', 'file_4', 'title_4', 1, utc_timestamp() - interval 15 day, utc_timestamp() - interval 15 day, 'public', '4.0'),
                               (159, 'slug_5', 'file_5', 'title_5', 1, utc_timestamp() - interval 8 day, utc_timestamp() - interval 8 day, 'public', '4.0'),
                               (179, 'slug_6', 'file_6', 'title_6', 1, utc_timestamp() - interval 9 day, utc_timestamp() - interval 9 day, 'public', '4.0'),
                               (159, 'slug_7', 'file_7', 'title_7', 1, utc_timestamp() - interval 18 day, utc_timestamp() - interval 18 day, 'private', '4.0'),
                               (179, 'slug_8', 'file_8', 'title_8', 1, utc_timestamp() - interval 16 day, utc_timestamp() - interval 16 day, 'public', '4.0'),
                               (159, 'slug_9', 'file_9', 'title_9', 1, utc_timestamp() - interval 14 day, utc_timestamp() - interval 14 day, 'public', '4.0'),
                               (179, 'slug_10', 'file_10', 'title_10', 1, utc_timestamp() - interval 13 day, utc_timestamp() - interval 13 day, 'public', '4.0'),
                               (179, 'slug_11', 'file_11', 'title_11', 1, utc_timestamp() - interval 19 day, utc_timestamp() - interval 19 day, 'public', '4.0'),
                               (169, 'slug_12', 'file_12', 'title_12', 1, utc_timestamp() - interval 12 day, utc_timestamp() - interval 12 day, 'public', '4.0'),
                               (159, 'slug_13', 'file_13', 'title_13', 1, utc_timestamp() - interval 4 day, utc_timestamp() - interval 4 day, 'private', '4.0'),
                               (169, 'slug_14', 'file_14', 'title_14', 1, utc_timestamp() - interval 5 day, utc_timestamp() - interval 5 day, 'public', '4.0'),
                               (159, 'slug_15', 'file_15', 'title_15', 1, utc_timestamp() - interval 1 day, utc_timestamp() - interval 1 day, 'public', '4.0'),
                               (179, 'slug_16', 'file_16', 'title_16', 1, utc_timestamp() - interval 11 day, utc_timestamp() - interval 11 day, 'public', '4.0'),
                               (159, 'slug_17', 'file_17', 'title_17', 1, utc_timestamp() - interval 6 day, utc_timestamp() - interval 6 day, 'private', '4.0'),
                               (159, 'slug_18', 'file_18', 'title_18', 1, utc_timestamp() - interval 17 day, utc_timestamp() - interval 17 day, 'public', '4.0'),
                               (179, 'slug_19', 'file_19', 'title_19', 1, utc_timestamp() - interval 20 day, utc_timestamp() - interval 20 day, 'public', '4.0'),
                               (169, 'slug_20', 'file_20', 'title_20', 1, utc_timestamp() - interval 7 day, utc_timestamp() - interval 7 day, 'public', '4.0'),
                               (159, 'slug_21', 'file_21', 'title_21', 1, utc_timestamp() - interval 21 day, utc_timestamp() - interval 21 day, 'public', '4.0'),
                               (159, 'slug_22', 'file_22', 'title_22', 1, utc_timestamp() - interval 22 day, utc_timestamp() - interval 22 day, 'private', '4.0'),
                               (159, 'slug_23', 'file_23', 'title_23', 1, utc_timestamp() - interval 23 day, utc_timestamp() - interval 23 day, 'public', '4.0'),
                               (159, 'slug_24', 'file_24', 'title_24', 1, utc_timestamp() - interval 24 day, utc_timestamp() - interval 24 day, 'private', '4.0'),
                               (159, 'slug_25', 'file_25', 'title_25', 1, utc_timestamp() - interval 25 day, utc_timestamp() - interval 25 day, 'public', '4.0'),
                               (159, 'slug_26', 'file_26', 'title_26', 1, utc_timestamp() - interval 26 day, utc_timestamp() - interval 26 day, 'private', '4.0'),
                               (159, 'slug_27', 'file_27', 'title_27', 1, utc_timestamp() - interval 27 day, utc_timestamp() - interval 27 day, 'public', '4.0'),
                               (159, 'slug_28', 'file_28', 'title_28', 1, utc_timestamp() - interval 28 day, utc_timestamp() - interval 28 day, 'private', '4.0'),
                               (159, 'slug_29', 'file_29', 'title_29', 1, utc_timestamp() - interval 29 day, utc_timestamp() - interval 29 day, 'public', '4.0'),
                               (179, 'slug_30', 'file_30', 'title_30', 1, utc_timestamp() - interval 30 day, utc_timestamp() - interval 30 day, 'private', '4.0'),
                               (159, 'slug_31', 'file_31', 'title_31', 1, utc_timestamp() - interval 31 day, utc_timestamp() - interval 31 day, 'public', '4.0'),
                               (159, 'slug_32', 'file_32', 'title_32', 1, utc_timestamp() - interval 32 day, utc_timestamp() - interval 32 day, 'private', '4.0'),
                               (159, 'slug_33', 'file_33', 'title_33', 1, utc_timestamp() - interval 33 day, utc_timestamp() - interval 33 day, 'public', '4.0'),
                               (169, 'slug_34', 'file_34', 'title_34', 1, utc_timestamp() - interval 34 day, utc_timestamp() - interval 34 day, 'private', '4.0'),
                               (159, 'slug_35', 'file_35', 'title_35', 1, utc_timestamp() - interval 35 day, utc_timestamp() - interval 35 day, 'public', '4.0'),
                               (159, 'slug_36', 'file_36', 'title_36', 1, utc_timestamp() - interval 36 day, utc_timestamp() - interval 36 day, 'private', '4.0'),
                               (159, 'slug_37', 'file_37', 'title_37', 1, utc_timestamp() - interval 37 day, utc_timestamp() - interval 37 day, 'public', '4.0'),
                               (159, 'slug_38', 'file_38', 'title_38', 1, utc_timestamp() - interval 38 day, utc_timestamp() - interval 38 day, 'private', '4.0'),
                               (159, 'slug_39', 'file_39', 'title_39', 1, utc_timestamp() - interval 39 day, utc_timestamp() - interval 39 day, 'public', '4.0'),
                               (169, 'slug_40', 'file_40', 'title_40', 1, utc_timestamp() - interval 40 day, utc_timestamp() - interval 40 day, 'private', '4.0'),
                               (159, 'slug_41', 'file_41', 'title_41', 1, utc_timestamp() - interval 41 day, utc_timestamp() - interval 41 day, 'public', '4.0'),
                               (159, 'slug_42', 'file_42', 'title_42', 1, utc_timestamp() - interval 42 day, utc_timestamp() - interval 42 day, 'public', '4.0'),
                               (159, 'slug_43', 'file_43', 'title_43', 1, utc_timestamp() - interval 43 day, utc_timestamp() - interval 43 day, 'public', '4.0')
                    SQL,
                ],
                'slug'        => '/search/?form-search-input-query=tle&form-search-select-ue_version=4.0&page=1',
                'location'    => null,
                'userID'      => null,
                'contentHead' => [
                    'title'       => 'Search "tle" | Page 1 | This is a base title',
...
<a class="pagination__link" href="&#x2F;search&#x2F;&#x3F;form-search-input-query&#x3D;tle&amp;form-search-select-ue_version&#x3D;4.0&amp;page&#x3D;2" aria-label="Page&#x20;2">2</a>
</li>
<li class="pagination__item">
<a class="pagination__link" href="&#x2F;search&#x2F;&#x3F;form-search-input-query&#x3D;tle&amp;form-search-select-ue_version&#x3D;4.0&amp;page&#x3D;2" aria-label="Next&#x20;page">Next page</a>
</li>
</ul>
HTML,
            ],
    ...
    public static function dataCases30PublicUnlistedPrivateBlueprintPage2(): array
    {
        ...
        return [
            '30 blueprints public/unlisted/private - (visitor profile) - page 2' => [
                ...
                'slug'        => '/search/?form-search-input-query=tle&form-search-select-ue_version=4.0&page=2',
                'location'    => null,
                'userID'      => null,
                'contentHead' => [
                    'title'       => 'Search "tle" | Page 2 | This is a base title',
                    'description' => 'Search "tle" in blueprints pasted'
                ],
                'contentBlueprintsHTML' => <<<HTML
<div class="block__container block__container--white-grey block__container--shadow-top block__container--last">
...
<ul class="pagination__items">
<li class="pagination__item">
<a class="pagination__link" href="&#x2F;search&#x2F;&#x3F;form-search-input-query&#x3D;tle&amp;form-search-select-ue_version&#x3D;4.0&amp;page&#x3D;1" aria-label="Previous&#x20;page">Previous page</a>
</li>
<li class="pagination__item">
<a class="pagination__link" href="&#x2F;search&#x2F;&#x3F;form-search-input-query&#x3D;tle&amp;form-search-select-ue_version&#x3D;4.0&amp;page&#x3D;1" aria-label="Page&#x20;1">1</a>
</li>
<li class="pagination__item pagination__item--current">
