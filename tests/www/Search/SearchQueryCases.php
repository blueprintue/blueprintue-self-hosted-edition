            ...
            '3 blueprints public/unlisted/private - created but not published - (visitor profile)' => [
                'sqlQueries' => [
                    ...
                    INSERT INTO blueprints (`id_author`, `slug`, `file_id`, `title`, `current_version`, `created_at`, `exposure`, `type`) VALUES
                                           (159, 'slug_500', 'file_500', 'sync function', 1, utc_timestamp(), 'public', 'blueprint'),
                ...
                'slug'        => '/search/?form-search-input-query=tle&page=1',
                'location'    => null,
                'userID'      => null,
                'contentHead' => [
            ...
            '3 blueprints public/unlisted/private - deleted - (visitor profile)' => [
                'sqlQueries' => [
                    ...
                    INSERT INTO blueprints (`id_author`, `slug`, `file_id`, `title`, `current_version`, `created_at`, `published_at`, `exposure`, `deleted_at`, `type`) VALUES
                                           (159, 'slug_500', 'file_500', 'sync function', 1, utc_timestamp(), utc_timestamp(), 'public', utc_timestamp(), 'blueprint'),
            ...
            '3 blueprints public/unlisted/private - (visitor profile)' => [
                'sqlQueries' => [
                    ...
                    INSERT INTO blueprints (`id_author`, `slug`, `file_id`, `title`, `current_version`, `created_at`, `published_at`, `exposure`, `type`) VALUES
                                           (159, 'slug_500', 'file_500', 'sync function', 1, utc_timestamp(), utc_timestamp(), 'public', 'blueprint'),
                ...
                'sqlQueries' => [
                    ...
                    INSERT INTO blueprints (`id_author`, `slug`, `file_id`, `title`, `current_version`, `created_at`, `published_at`, `exposure`)
                        VALUES (179, 'slug_1', 'file_1', 'title_1', 1, utc_timestamp() - interval 2 day, utc_timestamp() - interval 2 day, 'public'),
                               (159, 'slug_500', 'file_500', 'sync function', 1, utc_timestamp(), utc_timestamp(), 'public'),
...
<a class="pagination__link" href="&#x2F;search&#x2F;&#x3F;form-search-input-query&#x3D;tle&amp;page&#x3D;2" aria-label="Page&#x20;2">2</a>
</li>
<li class="pagination__item">
<a class="pagination__link" href="&#x2F;search&#x2F;&#x3F;form-search-input-query&#x3D;tle&amp;page&#x3D;2" aria-label="Next&#x20;page">Next page</a>
</li>
</ul>
HTML,
            ],
    ...
    public static function dataCases30PublicUnlistedPrivateBlueprintPage2(): array
    {
        ...
        return [
            '30 blueprints public/unlisted/private - (visitor profile) - page 2' => [
                ...
                'slug'        => '/search/?form-search-input-query=tle&page=2',
                'location'    => null,
                'userID'      => null,
                'contentHead' => [
...
<ul class="pagination__items">
<li class="pagination__item">
<a class="pagination__link" href="&#x2F;search&#x2F;&#x3F;form-search-input-query&#x3D;tle&amp;page&#x3D;1" aria-label="Previous&#x20;page">Previous page</a>
</li>
<li class="pagination__item">
<a class="pagination__link" href="&#x2F;search&#x2F;&#x3F;form-search-input-query&#x3D;tle&amp;page&#x3D;1" aria-label="Page&#x20;1">1</a>
</li>
<li class="pagination__item pagination__item--current">
