...
class BlueprintEditPOSTEditInformationsTest extends TestCase
{
    ...
    public function dataCasesEditInformations(): array
    {
        return [
            'update OK - title' => [
                'sql_queries' => [
            ...
            'update OK - description to text' => [
                ...
                'fields_has_error'      => [],
                'fields_has_value'      => ['title', 'description', 'tags'],
                'fields_label_error'    => [],
                'tagsTextarea'          => '',
                'tags'                  => [],
            ],
            ...
            'update OK - video to text' => [
                ...
                'fields_has_error'      => [],
                'fields_has_value'      => ['title', 'tags', 'video'],
                'fields_label_error'    => [],
                'tagsTextarea'          => '',
                'tags'                  => [],
            ],
            ...
            'update OK - xss' => [
                ...
                'fields_has_error'      => [],
                'fields_has_value'      => ['title', 'description', 'tags', 'video'],
                'fields_label_error'    => [],
                'tagsTextarea'          => '',
                'tags'                  => [],
            ],
